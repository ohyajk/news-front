...
const Haryana = () => {
    return (
        < section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-1" >
            <div className=" cursor-pointer p-2 bg-news-white flex flex-col gap-2  rounded-md hover:text-news-red">
